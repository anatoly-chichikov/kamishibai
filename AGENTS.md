...
collapsed**: an open block already shows the card's own metadata, and repeating
the tags there would only point at controls that live one row further down. At
...
tags.
The open editor puts the summary
