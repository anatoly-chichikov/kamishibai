...
from create_anki_deck import JsonReader


class TestJsonReaderReadsValidEntry:
    """
    JsonReader correctly parses valid vocabulary entries
    """
...
class TestJsonReaderFiltersInvalidEntries:
    """
    JsonReader skips entries without required fields
    """
...
class TestJsonReaderHandlesSpecialCharacters:
    """
    JsonReader handles commas, quotes, and special characters that break CSV
    """
